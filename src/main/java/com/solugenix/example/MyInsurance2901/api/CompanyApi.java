...
public interface CompanyApi {
    ...
    @ApiOperation(value = "", nickname = "getCompanies", notes = "", response = Company.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Get Company List", response = Company.class, responseContainer = "List") })
