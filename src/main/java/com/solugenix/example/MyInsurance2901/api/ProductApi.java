...
public interface ProductApi {
    ...
    @ApiOperation(value = "", nickname = "getProducts", notes = "", response = Product.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Product List", response = Product.class, responseContainer = "List") })
